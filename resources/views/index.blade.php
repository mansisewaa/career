                ...
                <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg)">
                    <div class="carousel-container">
                        <div class="container">
                            ...
                            <p class="animate__animated animate__fadeInUp">India's most efficient and reliable career
                                counselling ecosystem that creates life-changing experiences for students, professionals and
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row content">
                    <div class="col-lg-6">
                        <p>
                            We understand that each person is unique, with distinct talents, aspirations, and challenges.
                            That's why our team of experienced career counselors is committed to providing personalized
                            guidance tailored to your specific needs.
                        </p>
                        <ul>
                            <li><i class="ri-check-double-line"></i> Personalized Guidance</li>
                            <li><i class="ri-check-double-line"></i> Service Offerings</li>
                            <li><i class="ri-check-double-line"></i> Up-to-Date Advice</li>
                        </ul>
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0">
                        <p>
                            Where we are dedicated to guiding you on the path to a fulfilling and successful career journey.
                            Our mission is to empower individuals like you to make informed decisions about their
                            professional lives, ensuring they navigate the complexities of the job market with confidence
                            and clarity.
                        </p>
